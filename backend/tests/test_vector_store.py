...
def test_get_qdrant_client_returns_client():
    ...
    with (
        patch("gnosis.services.vector_store._client", None),
...
def test_ensure_collection_creates_when_missing():
    ...
    with (
        patch("gnosis.services.vector_store.get_qdrant_client", return_value=fake_client),
        patch(
            "gnosis.services.vector_store.get_settings",
