...
# mypy: ignore-errors
# Rationale: str | None body fields are guarded at runtime but mypy cannot
# narrow them through FastAPI's dynamic Body() injection. The four indexing
# errors (lines 299, 332, 374, 399) and the ingest_note arg-type error (611)
# are all false positives. Suppressing at module level is correct here.
